      ...
      <section className="layout pt-20 mt-4">
        ...
        <div className="mt-4">
          ...
          <article className="prose mt-2 dark:prose-invert">
            <ul>
              <li>
                <span className="font-bold">{"Bachelor's"} Degree (2012)</span>
                <br />
                <span>FMIPA MATEMATIKA UNIVERSITAS RIAU</span>
              </li>
              <li>
                <span className="font-bold">{"Master's"} Degree (2016)</span>
                <br />
                <span>FMIPA MATEMATIKA UNIVERSITAS ANDALAS</span>
              </li>
            </ul>
          </article>
          <h3 className="h4 mt-4">Languages</h3>
          <article className="prose mt-2 dark:prose-invert">
            <ul>
              <li>Indonesia</li>
              <li>English</li>
